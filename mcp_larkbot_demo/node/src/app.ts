...
import { LarkChatProvider } from './provider/lark';
import path from 'path';

// 初始化
// Initialize
// 对于 Lark 用户，建议使用 LarkWebhookChatProvider，WebSocket不支持Lark，使用 Webhook 可能需要内网穿透
// For Lark user please use LarkWebhookChatProvider, websocket is not supported，using webhook may need a tunnel
// const providers = [new LarkWebhookChatProvider()];
const providers = [new LarkChatProvider()];
