...
export const config = {
  ...
  lark: {
    // 飞书应用ID，从环境变量获取
    // Lark App ID from environment variables
    appId: process.env.APP_ID || '',

    // 飞书应用密钥，从环境变量获取
    // Lark App Secret from environment variables
    ...
    // OAuth授权范围，当前为空数组表示使用默认权限
    // OAuth authorization scopes, empty array means using default permissions
    scope: [],
  },
